...
struct ContentView: View {
    @State private var sab = false
    // Variables para personalizar
    let colorDeFondo: Color = Color(hex: "#33C3A7")
    let colorDelBoton: Color = Color(hex: "#32FF89").opacity(0.7)
    let colorDelTexto: Color = Color(hex: "#FFFFFF")
    let nombreDeLaApp: String = "súper puerqui"
    let nombreDelCreador: String = "sofia"
    let escenaDeSpline = URL(string: "https://build.spline.design/vabMocB8mKJtKq1tNH2g/scene.splineswift")!
