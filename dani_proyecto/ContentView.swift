...
struct ContentView: View {
    ...
    let colorDeFondo: Color = Color(hex: "#1268E4")
    let colorDelBoton: Color = Color(hex: "#32FF89").opacity(0.7)
    let colorDelTexto: Color = Color(hex: "#FFFFFF")

    let nombreDeLaApp: String = "create you house"
    let nombreDelCreador: String = "daniela"
    let escenaDeSpline = URL(string: "https://build.spline.design/QDojn2yKtvZmWDo4FEn2/scene.splineswift")!
