...
//
//  Created by Isa Aurora      on 26/07/24.
//
...
struct ContentView: View {
    ...
    let colorDeFondo: Color = Color(hex: "")
    let colorDelBoton: Color = Color(hex: "#32FF89").opacity(0.7)
    let colorDelTexto: Color = Color(hex: "#FFFFFF")
    let nombreDeLaApp: String = "Mi Aplicación Increible"
    let nombreDelCreador: String = "Isabel Aurora Santiago"
    let escenaDeSpline = URL(string: "https://build.spline.design/qQ3StAWClsyRsNuuM41U/scene.splineswift")!
