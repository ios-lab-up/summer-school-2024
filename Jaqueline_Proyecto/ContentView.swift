...
//
//  Created by Jaqueline Vargas Hdz  on 26/07/24.
//
...
struct ContentView: View {
    ...
    let nombreDelCreador: String = "Jaqueline Vargas Hernandez"
    let escenaDeSpline = URL(string: "https://build.spline.design/OA1K8KRS7ct-J721ZTYd/scene.splineswift")!
    
    var body: some View{
        
        if showRealityComposerView
        { RealityComposerView()}
        else{
            VStack(spacing: 20) {
